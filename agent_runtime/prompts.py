...
SEARCH_AGENT_PROMPT = (
    ...
    "`neo4j_explore_related_nodes` for its related elements, or `mcp_fetch_element_source` "
    "(when available) for its source file — NOT `semantic_search`. Never paraphrase, "
    "summarize, or drop the id.\n"
